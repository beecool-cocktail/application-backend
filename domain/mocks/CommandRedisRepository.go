...
// NewCommandRedisRepository creates a new instance of CommandRedisRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCommandRedisRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *CommandRedisRepository {
	mock := &CommandRedisRepository{}
	mock.Mock.Test(t)
