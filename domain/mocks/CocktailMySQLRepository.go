...
// DecreaseNumberOfCollectionTx provides a mock function with given fields: ctx, tx, cocktailID
func (_m *CocktailMySQLRepository) DecreaseNumberOfCollectionTx(ctx context.Context, tx *gorm.DB, cocktailID int64) (int64, error) {
	ret := _m.Called(ctx, tx, cocktailID)

	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gorm.DB, int64) (int64, error)); ok {
		return rf(ctx, tx, cocktailID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *gorm.DB, int64) int64); ok {
		r0 = rf(ctx, tx, cocktailID)
	} else {
		r0 = ret.Get(0).(int64)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *gorm.DB, int64) error); ok {
		r1 = rf(ctx, tx, cocktailID)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *CocktailMySQLRepository) GetAllWithFilter(ctx context.Context, filter map[string]interface{}, pagination domain.PaginationMySQLRepository) ([]domain.Cocktail, int64, error) {
	...
	var r1 int64
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, map[string]interface{}, domain.PaginationMySQLRepository) ([]domain.Cocktail, int64, error)); ok {
...
// IncreaseNumberOfCollectionTx provides a mock function with given fields: ctx, tx, cocktailID
func (_m *CocktailMySQLRepository) IncreaseNumberOfCollectionTx(ctx context.Context, tx *gorm.DB, cocktailID int64) (int64, error) {
	ret := _m.Called(ctx, tx, cocktailID)
...
func (_m *CocktailMySQLRepository) QueryByCocktailID(ctx context.Context, id int64) (domain.Cocktail, error) {
	...
	var r0 domain.Cocktail
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64) (domain.Cocktail, error)); ok {
		return rf(ctx, id)
	}
...
func (_m *CocktailMySQLRepository) UpdateCategoryTx(ctx context.Context, tx *gorm.DB, c *domain.Cocktail) (int64, error) {
	...
	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *gorm.DB, *domain.Cocktail) (int64, error)); ok {
		return rf(ctx, tx, c)
	}
...
// NewCocktailMySQLRepository creates a new instance of CocktailMySQLRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCocktailMySQLRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *CocktailMySQLRepository {
	mock := &CocktailMySQLRepository{}
	mock.Mock.Test(t)
