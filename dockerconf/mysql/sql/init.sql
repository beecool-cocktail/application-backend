...
(
    ...
    `coordinate_x2`        float                                   NOT NULL DEFAULT 0 COMMENT '照片左下X座標',
    `coordinate_y2`        float                                   NOT NULL DEFAULT 0 COMMENT '照片左下Y座標',
    `rotation`             float                                   NOT NULL DEFAULT 0 COMMENT '照片旋轉角度',
...
INSERT INTO `users` (`id`, `account`, `password`, `status`, `type`, `name`, `email`, `origin_avatar`, `crop_avatar`,
                     `height`, `width`, `coordinate_x1`, `coordinate_y1`, `coordinate_x2`, `coordinate_y2`, `rotation`,
                     `number_of_post`, `number_of_collection`, `number_of_draft`, `is_collection_public`, `remark`,
                     `created_date`)
VALUES (1, 'mockAccount1', '', 1, 1, 'mockUser1', '', '', '', 30, 10, 5, 5, 10, 10, 0, 0, 0, 0, 0, '', '2022-03-12 13:36:24'),
       (2, 'mockAccount2', '', 1, 1, 'mockUser2', '', '', '', 30, 10, 5, 5, 10, 10, 0, 0, 0, 0, 0, '', '2022-03-12 13:36:24'),
       (3, 'mockAccount3', '', 1, 1, 'mockUser3', '', '', '', 30, 10, 5, 5, 10, 10, 0, 0, 0, 0, 0, '', '2022-03-12 13:36:24'),
       (4, 'mockAccount4', '', 1, 1, 'mockUser4', '', '', '', 30, 10, 5, 5, 10, 10, 0, 0, 0, 0, 1, '', '2022-03-12 13:36:24'),
       (5, 'mockAccount5', '', 1, 1, 'mockUser5', '', '', '', 30, 10, 5, 5, 10, 10, 0, 0, 0, 0, 1, '', '2022-03-12 13:36:24'),
       (6, 'mockAccount6', '', 1, 1, 'mockUser6', '', '', '', 30, 10, 5, 5, 10, 10, 0, 0, 0, 0, 1, '', '2022-03-12 13:36:24');
...
(
    `id`                    bigint(64)                              NOT NULL AUTO_INCREMENT,
    `low_quality_bundle_id` bigint(64)                              NOT NULL DEFAULT '0',
    `cocktail_id`           bigint(64)                              NOT NULL,
    ...
    `is_low_quality`        tinyint(1)                              NOT NULL DEFAULT '0' COMMENT ' 是否為低畫質版本 0=否, 1=是',
    `order`                 tinyint(1)                              NOT NULL DEFAULT '1' COMMENT ' 排序',
    `created_date`          timestamp                               NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY `idx_lqip_bundle_id` (`low_quality_bundle_id`),
    KEY `idx_cocktail_id` (`cocktail_id`),
    KEY `idx_date` (`created_date`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
...
INSERT INTO `cocktail_photos` (`id`, `low_quality_bundle_id`, `cocktail_id`, `photo`, `is_cover_photo`,
                               `is_low_quality`, `order`, `created_date`)
VALUES (1, 1, 123456, 'static/my_image01.webp', 1, 0, 1, '2022-02-11 13:42:48'),
       (2, 1, 123456, 'static/my_image01_lq.webp', 1, 1, 1, '2022-02-11 13:42:48'),
       (3, 2, 1111111, 'static/my_image01.webp', 1, 0, 1, '2022-02-11 13:42:48'),
       (4, 2, 1111111, 'static/my_image01_lq.webp', 1, 1, 1, '2022-02-11 13:42:48'),
       (5, 3, 222222, 'static/my_image01.webp', 1, 0, 1, '2022-02-11 13:42:48'),
       (6, 3, 222222, 'static/my_image01_lq.webp', 1, 1, 1, '2022-02-11 13:42:48'),
       (7, 4, 333333, 'static/my_image01.webp', 1, 0, 1, '2022-02-11 13:42:48'),
       (8, 4, 333333, 'static/my_image01_lq.webp', 1, 1, 1, '2022-02-11 13:42:48'),
       (9, 5, 444444, 'static/my_image01.webp', 1, 0, 1, '2022-02-11 13:42:48'),
       (10, 5, 444444, 'static/my_image01_lq.webp', 1, 1, 1, '2022-02-11 13:42:48'),
       (11, 6, 555555, 'static/my_image01.webp', 1, 0, 1, '2022-02-11 13:42:48'),
       (12, 6, 555555, 'static/my_image01_lq.webp', 1, 1, 1, '2022-02-11 13:42:48'),
       (13, 7, 666666, 'static/my_image01.webp', 1, 0, 1, '2022-02-11 13:42:48'),
       (14, 7, 666666, 'static/my_image01_lq.webp', 1, 1, 1, '2022-02-11 13:42:48'),
       (15, 8, 777777, 'static/my_image01.webp', 1, 0, 1, '2022-02-11 13:42:48'),
       (16, 8, 777777, 'static/my_image01_lq.webp', 1, 1, 1, '2022-02-11 13:42:48'),
       (17, 9, 888888, 'static/my_image01.webp', 1, 0, 1, '2022-02-11 13:42:48'),
       (18, 9, 888888, 'static/my_image01_lq.webp', 1, 1, 1, '2022-02-11 13:42:48'),
       (19, 10, 999999, 'static/my_image01.webp', 1, 0, 1, '2022-02-11 13:42:48'),
       (20, 10, 999999, 'static/my_image01_lq.webp', 1, 1, 1, '2022-02-11 13:42:48'),
       (21, 11, 12121212, 'static/my_image01.webp', 1, 0, 1, '2022-02-11 13:42:48'),
       (22, 11, 12121212, 'static/my_image01_lq.webp', 1, 1, 1, '2022-02-11 13:42:48');
...
(
    ...
    `number_of_collection` int                                     NOT NULL DEFAULT 0 COMMENT '收藏數',
    `created_date`         timestamp                               NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
...
INSERT INTO `cocktails` (`id`, `cocktail_id`, `title`, `description`, `user_id`, `category`, `number_of_collection`,
                         `created_date`)
VALUES (1, 123456, 'Side Car', 'Good to drink', 1, 1, 0, '2021-01-15 18:38:30'),
       (2, 1111111, 'Old Fashion', 'Good to drink', 1, 1, 0, '2021-02-15 18:38:30'),
       (3, 222222, 'Gin tonic', 'Good to drink', 1, 1, 0, '2021-03-15 18:38:30'),
       (4, 333333, 'Very Impressive', 'Good to drink', 2, 1, 0, '2021-04-15 18:38:30'),
       (5, 444444, 'Pathetic', 'Good to drink', 2, 1, 0, '2021-05-15 18:38:30'),
       (6, 555555, 'Old Fashion', 'Good to drink', 3, 1, 2, '2021-12-10 18:38:30'),
       (7, 666666, 'Old Fashion', 'Good to drink', 3, 1, 0, '2021-12-11 18:38:30'),
       (8, 777777, 'Old Fashion', 'Good to drink', 4, 1, 0, '2021-12-12 18:38:30'),
       (9, 888888, 'Old Fashion', 'Good to drink', 5, 1, 0, '2021-12-13 18:38:30'),
       (10, 999999, 'Old Fashion', 'Good to drink', 6, 1, 0, '2021-12-14 18:38:30'),
       (11, 12121212, 'Old Fashion', 'Good to drink', 6, 1, 0, '2021-12-15 18:38:30');
